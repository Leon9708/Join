...
function filterLetters() {
  const filteredLetters = contacts.reduce((acc, contact) => {
  ...
  showLetters(filteredLetters);
}

function showLetters(filteredLetters) {
  filteredLetters.sort();
...
function showEditContact(i) {
  ...
  document.getElementById("showContactImg").style.backgroundColor =
    contacts[i].color;
  showName();
}
...
function showSelectedContact(i) {
  ...
  document.getElementById("showContactBox").innerHTML = showSelectedContactHTML(
    contacts[i],
    i
  );

  document.getElementById("showContactCircle").style.backgroundColor =
    contacts[i].color;
  document.getElementById("buttonContact" + i).style.backgroundColor =
    "#2A3647";
...
function showContactDetails() {
  ...
  if (width < 1000) {
    if (
      document
        .getElementById("container_contacts_right")
    ...
    document.getElementById("container_contacts_right").innerHTML +=
      '<img onclick="closeContactDetails()" class="arrowLeft" src="../assets/img/arrow-left.png">';
  }
}
        ...
        <button id="buttonContact${i}" class="contact_card_button" onclick="showSelectedContact(${i}); showContactDetails()">
            <div class="contact_list_container">
                <div id="circle${i}" class="contact_list_img">
                    <p>${singleContact["firstName"].charAt(0)}${singleContact[
    "lastName"
  ].charAt(0)}</p>
                </div>
                <div class="contact_content">
                    <div id="contact" class="contact_list_name">
                        <p class="contact_name" id="contactName${i}">${
    singleContact["firstName"]
  } ${singleContact["lastName"]}</p>
                    </div>
...
function showSelectedContactHTML(selectedContact, i) {
  return `
        <div class="contact_list_content">
            <div id="showContactCircle" class="show_contact_img">${selectedContact[
              "firstName"
            ].charAt(0)}${selectedContact["lastName"].charAt(0)}</div>
            <div class="show_contact_box_name_add_task">
                <p class="show_contact_name">${selectedContact["firstName"]} ${
